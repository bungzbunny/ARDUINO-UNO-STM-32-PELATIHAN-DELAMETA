...
void loop() {
 ...
 //LOGIKA PROGRAM
  ...
  if(bacabutton1==1 && kunci1==0){
  delay (500);
  Serial.println("LED ON");
  digitalWrite(r,HIGH);
  kunci1=1;
  }else if(bacabutton1==1 && kunci1==1){
  delay (500);
  ...
  if(bacabutton2==1 && kunci1==0){
  delay (500);
  Serial.println("LED ON");
  digitalWrite(y,HIGH);
  kunci1=1;
  }else if(bacabutton2==1 && kunci1==1){
  delay (500);
  Serial.println("LED OFF");
  digitalWrite(y,LOW);
  kunci1=0;
  ...
  if(bacabutton3==1 && kunci1==0){
  delay (500);
  Serial.println("LED ON");
  digitalWrite(g,HIGH);
  kunci1=1;
  }else if(bacabutton3==1 && kunci1==1){
  delay (500);
  Serial.println("LED OFF");
  digitalWrite(g,LOW);
  kunci1=0;
